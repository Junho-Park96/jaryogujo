...
public class RecursionTest {
	public static void main(String[] args) {
		System.out.println("course2 : 박준호 \n");

		Scanner input = new Scanner(System.in);
		System.out.print("양의 정수 입력: \n");
		int number = input.nextInt();

		System.out.println("1부터 4까지의 합(반복) = " + iterativeSum(number));

		System.out.println("1부터 4까지의 합(재귀) = " + sum(number));

		System.out.println("1부터 4까지의 곱(반복) = " + iterativeFactorial(number));

		System.out.println("1부터 4까지의 곱(재귀) = " + factorial(number));
